...
public class Principal {
    ...
    private void buscarEpisodiosPorData() {
        ...
        if (serieBusca.isPresent()){
            ...
            System.out.println("Qual ano limite de lançamento:");
    ...
    private void episodioPorTrecho() {
        System.out.println("Buscar Episodio pelo nome:");
        var trechoEpisodio = leitura.nextLine();
        List<Episodio> episodiosTrecho = repositorio.episodiosPorTrecho(trechoEpisodio);
        episodiosTrecho.forEach(e ->
    ...
    private void filtrarSeries() {
        System.out.println("Filtrar séries até quantas temporada?");
        var totalTemporadas = leitura.nextInt();
        leitura.nextLine();
        System.out.println("Com avaliaçoes a partir de qual valor:");
    ...
    private void listarTop5() {
        ...
        topSerie.forEach(s -> System.out.println(s.getTitulo() + " Avaliação: " + s.getAvaliacao()));

    }

    private void buscarSeriePorAtor() {
        System.out.println("Buscar o nome do Ator: ");
        var nomeAtor = leitura.nextLine();
        System.out.println("Avaliações a partir de qual valor: ");
        var valorAvaliacao = leitura.nextDouble();
        List<Serie> serieEncontradas = repositorio.findByAtoresContainingIgnoreCaseAndAvaliacaoGreaterThanEqual(nomeAtor,valorAvaliacao);
    ...
    private void buscarSeriePorTitulo() {
        System.out.println("Buscar uma Série pelo nome: ");
